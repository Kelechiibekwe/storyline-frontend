...
export default function MusicPlayer({
  ...
  const handleDrop = (e: React.DragEvent, dropIndex: number) => {
    ...
    // Remove dragged item
    const newUpNext = upNextItems.filter((_, index) => index !== draggedIndex);
  ...
  return (
    <Card className="w-full bg-white border border-gray-300 shadow-xl shadow-black/20 ring-1 ring-gray-200">
